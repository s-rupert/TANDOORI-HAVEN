...
const LocationPage = () => {
  ...
  return (
    <div className={`${location ? "block" : "hidden"}`}>
      ...
      <p className="font-bold text-center text-lg md:text-xl lg:text-2xl xl:text-3xl mt-20">
        Visit Us Today!
      </p>
      <p className="text-center text-sm mt-2 md:text-base lg:text-lg xl:text-xl ">
        At Tandoori Haven, we’re proud to serve the Greater Toronto Area with
        authentic Indian cuisine in a warm, welcoming environment. Whether
        you're near Brampton, Mississauga, Scarborough, or Oakville, a delicious
