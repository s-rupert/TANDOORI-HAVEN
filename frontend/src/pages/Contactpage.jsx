...
const Contactpage = () => {
  const { contact, setContact } = useContext(PageContext);

  return (
    <div className={`${contact ? "block" : "hidden"} p-4`}>
      ...
      <div className="flex flex-col items-center justify-center mt-20">
        <p className="font-bold underline text-lg lg:text-xl">Visit our Locations</p>
      ...
      <p className="font-bold mt-15 text-center text-xl md:text-2xl lg:text-3xl xl:text-4xl underline">Contact Us</p>
      <div className="flex flex-wrap">
        ...
        <div className="flex flex-wrap justify-between w-full">
          ...
          <label className="block text-sm font-medium mb-2 font-semibold" htmlFor="name">
            Name
          </label>
          <input
            type="text"
        ...
        <div className="mb-4 w-[45%]">
          <label className="block text-sm font-medium mb-2 font-semibold" htmlFor="email">
            Email
          </label>
          <input
            type="email"
        ...
        <div className="mb-4">
          <label className="block text-sm font-medium mb-2 font-semibold" htmlFor="message">
            Message
          </label>
          <textarea
            id="message"
