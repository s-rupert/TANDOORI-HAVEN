...
const Chatbot = () => {
  ...
  return (
    <div id="chatbot" className="fixed flex flex-col bottom-10 right-15 z-20">
      <div className={`flex flex-col items-center ${help ? "hidden" : ""}`} onClick={() => (setHelp(true))}>
      ...
      <div className={`h-100 relative ${help ? "" : "hidden"}`} >
        ...
        <div className='absolute top-2 right-2 text-white hover:text-black' onClick={() => (setHelp(false))}><X size={25} /></div>
        ...
        <div className="flex-1 overflow-auto p-2 space-y-4 bg-white h-70 w-auto overflow-y-scroll">
          {messages.map((msg, idx) => (
            ...
            >
              <div className={`absolute min-w-[10%] max-w-[70%] rounded-lg px-4 py-2 ${msg.sender === "user"
